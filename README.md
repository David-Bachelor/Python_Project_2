...
The project dowmloaded data from one API then processed it to change expenses categorization and flag any that did not succesfully match for human review. When approved a file of the expenses are uploaded by another piece of code from a different project.
